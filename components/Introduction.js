  ...
  return (
    <div className='py-10'>
      ...
      <p className='mx-auto text-left text-xl'>
        I&apos;m a student at <a href='https://www.ucmerced.edu/about' target='_blank' rel='noopener noreferrer' className='underline hover:no-underline hover:text-gray-400'>University of California, Merced</a> majoring in computer science and engineering. I have a strong interest for software development and enjoy working on projects in my own time. Please feel free to look at my Github projects or to get in touch with me on one of my socials.
      </p>
    </div>
  )
}
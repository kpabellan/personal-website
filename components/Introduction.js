...
export const Introduction = () => {
  return (
    <div className='py-10'>
      ...
      I&apos;m a Computer Science and Engineering graduate from the <a href='https://www.ucmerced.edu/about' target='_blank' rel='noopener noreferrer' className='underline hover:no-underline hover:text-gray-400'> University of California, Merced</a>. From building to breaking, I have a strong passion for both software development and cybersecurity. In my free time, I&apos;m often working on projects or learning new skills and technologies. Outside the digital realm, I enjoy hiking, spending time outdoors, and capturing moments through photography. For any inquiries, please don&apos;t hesitate to reach out to me on my social media profiles.
      </p>
    </div>
  );
};